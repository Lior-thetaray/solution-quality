...
def config():
    ...
    Anomalous behavior indicating money laundry activity has been identified for customer-{{ activity.client_id }} by a machine learning
    ...
    Anomalous behavior indicating money laundering activity has been identified for customer - {{ activity.client_id }} by a rule based
    model.
    Rule Details:
