...
class WeeklyTrainWranglingExecution(WeeklyWranglingExecution):
    ...
    def get_read_date_range(self) -> Tuple[datetime.datetime, datetime.datetime]:
        start_date = self.train_start_date + dateutil.relativedelta.relativedelta(days=-self.max_look_back)
